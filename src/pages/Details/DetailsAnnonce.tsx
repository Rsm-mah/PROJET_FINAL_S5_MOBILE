  ...
  const DetailsAnnonce = () => {
    ...
    return (
        <div className='details'>
            ...
            <IonModal className='ion-modal' ref={modal} trigger="open-modal" isOpen={isModalOpen} initialBreakpoint={0.4} breakpoints={[0.25, 0.4, 0.7]} backdropDismiss={false} backdropBreakpoint={0.5}>
